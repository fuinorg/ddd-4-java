...
public final class TheRootCreateCommand extends AbstractAggregateCommand<TheRootId, TheEntityId> {
    ...
    public static final EventType TYPE = new EventType(TheRootCreateCommand.class.getSimpleName());
     ...
     */
    protected TheRootCreateCommand() { // NOSONAR Default constructor
        super();
    }
     ...
     */
    public static final class Builder extends AbstractAggregateCommand.Builder<TheRootId, TheEntityId, TheRootCreateCommand, Builder> {

        private TheRootCreateCommand delegate;

        private Builder() {
            super(new TheRootCreateCommand());
            delegate = delegate();
        }
