...
public final class TheRootId extends AggregateRootUuid {

    private static final long serialVersionUID = 1000L;

    /** Unique name of the aggregate this identifier refers to. */
    public static final EntityType TYPE = new StringBasedEntityType("THE_ROOT");
     ...
     *            Value.
     */
    public TheRootId(final UUID value) {
        super(TYPE, value);
    }
     ...
     */
    public static TheRootId valueOf(final String value) {
        if (value == null) {
            return null;
        }
        requireArgValid("value", value);
        return new TheRootId(UUID.fromString(value));
    }
    ...
    @Documented
    public static @interface TheRootIdStr {

        String message()

        default "{org.fuin.ddd4j.codegen.example.TheRootId.message}";
     ...
     */
    public static final class Validator implements ConstraintValidator<TheRootIdStr, String> {

        @Override
        public final void initialize(final TheRootIdStr annotation) {
            // Not used
        }

        @Override
        public final boolean isValid(final String value, final ConstraintValidatorContext context) {
            return TheRootId.isValid(value);
        }
     ...
     */
    public static final class Converter implements JsonbAdapter<TheRootId, UUID> {

        private TheRootId toVO(final UUID value) {
            if (value == null) {
                return null;
            }
            return new TheRootId(value);
        }

        private UUID fromVO(final TheRootId value) {
            if (value == null) {
                return null;
            }
        ...
        @Override
        public final UUID adaptToJson(final TheRootId obj) throws Exception {
            return fromVO(obj);
        }

        @Override
        public final TheRootId adaptFromJson(final UUID str) throws Exception {
            return toVO(str);
        }
