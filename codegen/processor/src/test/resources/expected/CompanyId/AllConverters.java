...
public final class CompanyId extends AggregateRootUuid {
     ...
     */
    public static final class Converter extends XmlAdapter<UUID, CompanyId> implements JsonbAdapter<CompanyId, UUID>, AttributeConverter<CompanyId, UUID> {
        ...
        @Override
        public final UUID adaptToJson(final CompanyId obj) throws Exception {
            return fromVO(obj);
        }

        @Override
        public final CompanyId adaptFromJson(final UUID str) throws Exception {
            return toVO(str);
        }
        ...
        @Override
        public final UUID convertToDatabaseColumn(final CompanyId value) {
            return fromVO(value);
        }

        @Override
        public final CompanyId convertToEntityAttribute(final UUID value) {
            return toVO(value);
        }
    }
