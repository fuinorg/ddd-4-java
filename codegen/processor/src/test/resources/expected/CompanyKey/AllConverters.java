...
@Immutable
@Schema(name = "CompanyKey", type = SchemaType.STRING, description = "Human readable unique key of a company", maxLength = 50, pattern = "[a-z0-9][a-z0-9-]+", example = "john-doe-inc")
public final class CompanyKey implements ValueObjectWithBaseType<String>, Comparable<CompanyKey>, Serializable, AsStringCapable {
     ...
     */
    public static final class Converter extends XmlAdapter<String, CompanyKey> implements JsonbAdapter<CompanyKey, String>, AttributeConverter<CompanyKey, String> {
        ...
        @Override
        public final String convertToDatabaseColumn(final CompanyKey value) {
            return fromVO(value);
        }

        @Override
        public final CompanyKey convertToEntityAttribute(final String value) {
            return toVO(value);
        }
    }
