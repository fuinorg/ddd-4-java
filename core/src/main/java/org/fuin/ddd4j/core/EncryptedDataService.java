...
public interface EncryptedDataService {
     ...
     *
     * @param keyId Identifier to test for.
     * @return TRUE if the key is known and can be used for encryption.
     */
    boolean keyExists(@NotEmpty String keyId);

    /**
     * Creates a new key for the given identifier.
     *
     * @param keyId Identifier to create a new secret key for.
     * @throws DuplicateEncryptionKeyIdException The given ID already exists and a key cannot be created again.
     */
    void createKey(@NotEmpty String keyId) throws DuplicateEncryptionKeyIdException;

    /**
     * Rotates the existing key by creating a new one as the next version.
     *
     * @param keyId Key identifier to create a new secret key.
     * @return The new version of the key.
     * @throws EncryptionKeyIdUnknownException The given key identifier is unknown.
     */
    String rotateKey(@NotEmpty String keyId) throws EncryptionKeyIdUnknownException;

    /**
     * Returns the current version of the given identifier.
     *
     * @param keyId Key ID to return the version for.
     * @return Version of the given identifier.
     * @throws EncryptionKeyIdUnknownException The given key identifier is unknown.
     */
    String getKeyVersion(@NotEmpty String keyId) throws EncryptionKeyIdUnknownException;
     ...
     *
     * @param keyId       Unique identifier of a key to use.
     * @param dataType    Unique type of the data like "UserPersonalData" or even a fully qualified class name.
     * @param contentType Content type like "application/json; encoding=UTF-8; version=1".
     * @param data        Data to encrypt.
     * @return Encrypted data.
     * @throws EncryptionKeyIdUnknownException The given key identifier is unknown.
     */
    EncryptedData encrypt(@NotEmpty String keyId, @NotEmpty String dataType, @NotEmpty String contentType, @NotEmpty byte[] data)
     ...
     * the target type.
     *
     * @param encryptedData Encrypted data and meta information about it.
