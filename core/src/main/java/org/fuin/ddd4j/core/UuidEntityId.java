...
/**
 * UUID based entity identifier. The counterpart of {@link IntegerEntityId} for a child entity that is
 * identified globally instead of sequentially within its aggregate.
 */
@Immutable
@HasPublicStaticIsValidMethod
public abstract class UuidEntityId implements EntityId, Comparable<UuidEntityId>, ValueObjectWithBaseType<UUID> {
    ...
    /**
     * Constructor with entity type that creates a new random UUID.
     *
     * @param entityType
     *            Entity type.
     */
    public UuidEntityId(final EntityType entityType) {
     ...
     *            UUID.
     */
    public UuidEntityId(final EntityType entityType, final UUID uuid) {
        super();
    ...
    public final boolean equals(final Object obj) {
        ...
        if (!(obj instanceof UuidEntityId other)) {
            return false;
        }
    ...
    @Override
    public final int compareTo(final UuidEntityId other) {
