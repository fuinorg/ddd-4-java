...
/**
 * Base class for lightweight persistence tests with an entity manager backed by the in-memory HSQLDB unit-test
 * database (persistence unit {@code testPU}, see {@code META-INF/persistence.xml}). No Docker required.
 */
