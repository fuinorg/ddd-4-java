...
/**
 * Asynchronous repository that is capable of storing vendors (async counterpart of {@link VendorRepository}).
 */
@TestOmitted("Only a test class")
public final class VendorRepositoryAsync extends EventStoreRepositoryAsync<VendorId, Vendor> {
     ...
     */
    public VendorRepositoryAsync(final EventStoreAsync eventStore) {
        super(eventStore);
    }
