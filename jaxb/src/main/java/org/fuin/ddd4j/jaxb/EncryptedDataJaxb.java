...
public final class EncryptedDataJaxb implements EncryptedData {
     ...
     */
    public EncryptedDataJaxb(@NotEmpty final String keyId, @NotEmpty final String keyVersion, @NotEmpty final String dataType,
    ...
    public final boolean equals(final Object obj) {
        ...
        final EncryptedDataJaxb other = (EncryptedDataJaxb) obj;
        if (contentType == null) {
