...
public final class EncryptedDataJsonb implements EncryptedData {
     ...
     */
    public EncryptedDataJsonb(@NotEmpty final String keyId, @NotEmpty final String keyVersion, @NotEmpty final String dataType,
    ...
    public final boolean equals(final Object obj) {
        ...
        final EncryptedDataJsonb other = (EncryptedDataJsonb) obj;
        if (contentType == null) {
