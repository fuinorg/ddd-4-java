...
public class EntityIdJsonbAdapterTest {

    @Test
    public void testUnmarshal() {

        // PREPARE
        final EntityIdJsonbAdapter testee = new EntityIdJsonbAdapter(new JsonbTestEntityIdFactory());
        final EntityId entityId = testee.adaptFromJson("A 1");
    ...
    public void testMarshal() {
        ...
        // TEST & VERIFY
        assertThat(testee.adaptToJson(entityId)).isEqualTo("A 1");
