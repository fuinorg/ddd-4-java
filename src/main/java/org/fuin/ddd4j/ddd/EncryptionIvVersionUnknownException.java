...
public final class EncryptionIvVersionUnknownException extends Exception
    ...
    public static final String SHORT_ID = SHORT_ID_PREFIX + "-ENCRYPTION_IV_VERSION_UNKNOWN";

    /** Unique name of the element to use for XML and JSON marshalling/unmarshalling. */
    public static final String ELEMENT_NAME = "encryption-iv-version-unknown-exception";
    ...
    public EncryptionIvVersionUnknownException(@NotEmpty final String ivVersion) {
        ...
        this.data = new Data(getMessage(), SHORT_ID, ivVersion);
    }
     ...
     */
    private EncryptionIvVersionUnknownException(final Data data) {
        super(data.message);
        this.data = data;
    }
    ...
    public static final class Data implements Serializable, ValueObject, ToExceptionCapable<EncryptionIvVersionUnknownException> {
         ...
         *            The IV version that caused the problem.
         */
        private Data(final String message, final String sid, final String ivVersion) {
            super();
        ...
        public String toString() {
            return "Data [message=" + message + ", sid=" + sid + ", ivVersion=" + ivVersion + "]";
        }

        public EncryptionIvVersionUnknownException toException() {
            return new EncryptionIvVersionUnknownException(this);
        }
